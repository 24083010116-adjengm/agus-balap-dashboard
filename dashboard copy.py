...
if menu == "🏠 Home":
    ...
    **Anggota Kelompok:**  
    ...
    with col1:
        ...
        Dataset mengandung variabel **kategorikal dan numerik**, memungkinkan analisis komprehensif terhadap perilaku digital mahasiswa.
        """)
    ...
    with col2:
        ...
        Sebanyak **172 responden** berpartisipasi, mewakili beragam jurusan dan angkatan, memberikan gambaran umum mengenai pola aktivitas digital mahasiswa.
        """)
        ...
        - Menyediakan **insight interaktif** untuk eksplorasi data secara visual sebelum analisis lanjutan
        """)

    # Logo Streamlit dihapus, diganti pesan sukses
...
# --- HALAMAN STATISTIK ---
    ...
    st.write("Statistik deskriptif dari data numerik:")
...
# --- HALAMAN VISUALISASI ---
    ...
    if chart_type == "Bar Chart":
        ...
        col = st.selectbox("Pilih Kolom Kategorik:", categorical_cols)
        fig, ax = plt.subplots()
        df[col].value_counts().plot(kind='pie', autopct='%1.1f%%', startangle=90, ax=ax)
        ax.set_ylabel("")
        ...
        if len(numeric_cols) >= 2:
            ...
            st.warning("Tidak cukup kolom numerik untuk membuat scatter plot.")
